...
namespace CluedIn.ExternalSearch.Providers.Gleif.Models
{
    public class Address
    {
        ...
        [JsonProperty("addressLines")] public List<string> AddressLines { get; set; }

        [JsonProperty("addressNumber")] public string AddressNumber { get; set; }

        [JsonProperty("addressNumberWithinBuilding")]
        public string AddressNumberWithinBuilding { get; set; }

        [JsonProperty("mailRouting")] public string MailRouting { get; set; }
