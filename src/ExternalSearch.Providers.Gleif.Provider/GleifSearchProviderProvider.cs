...
using Constants = CluedIn.ExternalSearch.Providers.Gleif.Constants;

namespace CluedIn.Provider.Gleif
{
    public class GleifSearchProviderProvider : ProviderBase, IExtendedProviderMetadata, IExternalSearchProviderProvider
    {
        public IExternalSearchProvider ExternalSearchProvider { get; }

        public GleifSearchProviderProvider([System.Diagnostics.CodeAnalysis.NotNull] ApplicationContext appContext) : base(appContext, GetMetaData())
        {
        ...
        public Dictionary<string, object> ExtraInfo { get; } = new()
        {
            ...
            { "vocabKeyPrefix", GleifVocabularies.Organization.KeyPrefix},
